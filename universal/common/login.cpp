...
int login::set(const ParameterList &pParams, QSplashScreen *pSplash)
{
	...
	{
		QSettings settings(QSettings::UserScope, "Panther", "ReportMaster");
		_databaseURL = settings.value("/OpenRPT/_databaseURL", QVariant("mysql://127.0.0.1/reports:3306")).toString();
	}
