...
**
** Created: Mon May 21 12:21:46 2012
...
public:
    ...
    {
        loginOptions->setWindowTitle(QApplication::translate("loginOptions", "Login Options", 0));
        _database->setText(QApplication::translate("loginOptions", "reports", 0));
        _databaseLit->setText(QApplication::translate("loginOptions", "&Database:", 0));
        _server->setText(QApplication::translate("loginOptions", "localhost", 0));
        _port->setText(QApplication::translate("loginOptions", "3306", 0));
        _serverLit->setText(QApplication::translate("loginOptions", "S&erver:", 0));
        _portLit->setText(QApplication::translate("loginOptions", "&Port:", 0));
        _driverLit->setText(QApplication::translate("loginOptions", "Driver:", 0));
        _driver->clear();
        _driver->insertItems(0, QStringList()
         << QApplication::translate("loginOptions", "QMYSQL", 0)
         << QApplication::translate("loginOptions", "QSQLITE", 0)
        );
        _close->setText(QApplication::translate("loginOptions", "&Cancel", 0));
        _save->setText(QApplication::translate("loginOptions", "&Save", 0));
    } // retranslateUi
