...
public:
    ...
    {
        login->setWindowTitle(QApplication::translate("login", "Log In", 0));
        _logo->setText(QString());
        _nameLit->setText(QString());
        _versionLit->setText(QString());
        _copyrightLit->setText(QString());
        _buildLit->setText(QApplication::translate("login", "Build: ", 0));
        _build->setText(QString());
        _usernameLit->setText(QApplication::translate("login", "&Username:", 0));
        _passwordLit->setText(QApplication::translate("login", "&Password:", 0));
        _username->setText(QApplication::translate("login", "root", 0));
        _password->setText(QApplication::translate("login", "kapsadmin", 0));
        _serverLit->setText(QApplication::translate("login", "S&erver:", 0));
        _databaseLit->setText(QApplication::translate("login", "&Database:", 0));
        _server->setText(QString());
        _database->setText(QString());
        _close->setText(QApplication::translate("login", "&Cancel", 0));
        _login->setText(QApplication::translate("login", "&Login", 0));
        _options->setText(QApplication::translate("login", "&Options", 0));
    } // retranslateUi
