...
{
	ui->stackedWidget->setCurrentWidget(m_shifts_2);
}
...
void Lists::resetUI()
{
	...
	m_holidays = new Holidays(this, db);
	m_months = new PayrollMonths(this, db);
	m_months->isAdmin = payrollAccess;
	//m_shifts = new Shifts(this, db);
	m_saccos = new Saccos(this, db);
	m_shifts_2 = new Shifts2(this, db);
	...
	ui->stackedWidget->addWidget(m_shifts_2);
