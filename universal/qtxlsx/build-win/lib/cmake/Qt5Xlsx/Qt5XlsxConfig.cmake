...
set(Qt5Xlsx_VERSION_STRING 0.2.0)
...
if (NOT TARGET Qt5::Xlsx)
    ...
    foreach(_module_dep ${_Qt5Xlsx_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                0.2.0 ${_Qt5Xlsx_FIND_VERSION_EXACT}
    ...
    _populate_Xlsx_target_properties(RELEASE "Qt0Xlsx.dll" "libQt0Xlsx.a" )



    _populate_Xlsx_target_properties(DEBUG "Qt0Xlsxd.dll" "libQt0Xlsxd.a" )
