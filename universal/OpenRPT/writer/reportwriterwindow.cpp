...
ReportWriterWindow::ReportWriterWindow()
  : QMainWindow() {
    ...
    setWindowTitle("Report Master Generator");
   ...
   setCentralWidget(ws);
    ...
    //My Code (Musele)
    _fieldDock = new QDockWidget("Field Explorer", this);
    //_fieldDock->setAllowedAreas(Qt::LeftDockWidgetArea);
    //_fieldDock->setFloating(false);
    _fieldDock->setVisible(true);

    //_myDock = new MyDock(ws);
